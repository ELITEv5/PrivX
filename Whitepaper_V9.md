...
Repository: github.com/elitev5/PrivX
...
Buterin, V. (2022). Privacy Pools and Zero-Knowledge on Ethereum.

Meiklejohn, S. et al. (2013). A Fistful of Bitcoins: Characterizing Payments Among Men with No Names. ACM CCS.

Tornado Cash Developers. (2021). Tornado Cash Smart Contracts v3.

Elite Labs. (2025). PrivX GitHub Repository.

PulseChain Docs. (2024). PulseChain Developer Reference.

Narayanan, A. (2015). Bitcoin and Cryptocurrency Technologies. Princeton University Press.
